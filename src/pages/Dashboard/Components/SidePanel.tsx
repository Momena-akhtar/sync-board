...
const SidePanel = () => {
  ...
  return (
    <div className="sm:flex-1 bg-[#1E1E1E] font-['Kumbh_Sans'] border-r border-[#383838] flex flex-col items-center p-4">
      {/* User Section */}
      <div className="flex items-center gap-2 w-full cursor-pointer rounded-lg p-2">
        <div className="flex items-center gap-2  hover:bg-[#383838] pt-1 pb-1 border-none rounded-lg flex-1" onClick={() => setIsProfileModalOpen(true)}>
          {getPhoto()}
      ...
      <div className="w-full mt-4 border border-zinc-700 p-3 rounded-lg">
        ...
        <div className="flex flex-col gap-2 mt-2">
          <div 
            className="flex items-center gap-2 cursor-pointer transition-transform hover:bg-[#383838] rounded-lg p-2"
      ...
      <div className="w-full mt-4">
        <div className="flex items-center justify-between cursor-pointer transition-transform hover:bg-[#383838] rounded-lg p-2">
